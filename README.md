...
| `s5_aggregate` | Agrega soporte geometrico entre runs y conserva metadatos de viabilidad multimodo. | Debe consumir runs validos; contabiliza clases de viabilidad y usa fallbacks explicitamente anotados. |
