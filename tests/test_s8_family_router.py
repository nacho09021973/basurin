...
from mvp.s8_family_router import FAMILY_BNS, FAMILY_GR_KERR, route_family_candidates
...
def test_router_prioritizes_bns_when_metadata_says_bns() -> None:
    ...
    assert routing["families_to_run"] == [FAMILY_BNS, FAMILY_GR_KERR]
...
def test_bns_family_handler_supports_matching_candidate() -> None:
    payload = assess_bns_family(
        router_payload={"primary_family": FAMILY_BNS, "families_to_run": [FAMILY_BNS, FAMILY_GR_KERR]},
