...
Consulta la guía operativa dedicada: [`docs/atlas_discovery.md`](./atlas_discovery.md).

Resumen rápido:
- No inventar `atlas.json` en raíz.
- Preferir `docs/ringdown/atlas/*_s4.json` para `s4_geometry_filter`.
- En dudas: `find . -maxdepth 6 -type f \( -name “atlas*.json” -o -name “*atlas*.json” \) | sort`.
